...
public class ParameterLegalityChecker {
  ...
  //length limitations on the users' fields
	 ...
	 * @throws IllegalUserNameLengthException if the name is of an illegal length
	 * @throws IllegalUserNameException if the name is illegal for any other reason
	 */
	 ...
	 * @throws IllegalUserRoleException if the role is illegal
	 */
	...
	throws IllegalUserUsernameException, IllegalUserUsernameLengthException {
		if (null == username) {
	...
	throws IllegalProjectNameException, IllegalProjectNameLengthException {
	  // TODO Auto-generated method stub
	  
  }

	void checkProjectDescription(String description)
	throws IllegalProjectDescriptionException, IllegalProjectDescriptionLengthException {
	  // TODO Auto-generated method stub
	  
  }

	void checkProjectLocation(String location)
	throws IllegalProjectLocationException, IllegalProjectLocationLengthException {
	  // TODO Auto-generated method stub
	  
  }

	void checkProjectEventTime(Date eventTime)
	throws IllegalProjectEventTimeException {
	  // TODO Auto-generated method stub
	  //TODO: check if null. check if in the past?
  }

	void checkItemName(String itemName)
	throws IllegalItemNameException, IllegalItemNameLengthException {
	  // TODO Auto-generated method stub
	  
  }

	void checkItemDescription(String itemDescription)
	throws IllegalItemDescriptionException, IllegalItemDescriptionLengthException {
	  // TODO Auto-generated method stub
	  
  }

	void checkCategoryName(String name)
	throws IllegalCategoryNameException, IllegalCategoryNameLengthException {
	  // TODO Auto-generated method stub
	  
  }

	void checkCategoryDescription(String name)
	throws IllegalCategoryDescriptionException, IllegalCategoryDescriptionLengthException {
	  // TODO Auto-generated method stub
